...
|54| dynamic array element removal|
...
|68|my first model: House Price Predictor (Simple Linear Regression)|

|69| linux fundamentals: [Linux Basics.docx](https://github.com/user-attachments/files/31734308/Linux.Basics.docx) |

|70|removing duplicates from sorted array|

|71| removing elements |

|72| Word & Character Counter|

|73| URL checking|

|74| fork & os|

|75| quick revesion abt: dynamic memory allocation|

|76| replace and finds array|

|77| lengh of last word|

|78| adding plus one( problem 66 on leet code)|

|79| Single Number( prb 136 on leet code)|

|80| Mathematical Art: Dynamic Glowing Heart|
